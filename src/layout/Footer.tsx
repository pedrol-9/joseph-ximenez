...
export const Footer = () => {
        ...
        <ul className="space-y-4 text-sm font-light text-[#E8E2D2]/70">
          <li>
            <Link
              ...
              className="hover:text-[#C1533B] transition-colors"
              style={{ color: isActive("/#inicio") ? "#C1533B" : "inherit" }}
            >
              El Origen
            </Link>
          </li>
          <li>
            <Link
              href="/#pasado"
              onClick={() => setActiveLink("/#pasado")}
              className="hover:text-[#C1533B] transition-colors"
              style={{ color: isActive("/#pasado") ? "#C1533B" : "inherit" }}
            >
              Infancia y juventud
            </Link>
          </li>
          <li>
            <Link
              href="/#retiro"
              onClick={() => setActiveLink("/#retiro")}
              className="hover:text-[#C1533B] transition-colors"
              style={{ color: isActive("/#retiro") ? "#C1533B" : "inherit" }}
            >
              El Retiro
            </Link>
          </li>
          <li>
            <Link
              href="/#hoguera"
              onClick={() => setActiveLink("/#hoguera")}
              className="hover:text-[#C1533B] transition-colors"
              style={{ color: isActive("/#hoguera") ? "#C1533B" : "inherit" }}
            >
              La Hoguera
            </Link>
          </li>
          <li>
            <Link
              href="/#legado"
              onClick={() => setActiveLink("/#legado")}
              className="hover:text-[#C1533B] transition-colors"
              style={{ color: isActive("/#legado") ? "#C1533B" : "inherit" }}
            >
              El Legado
            </Link>
          </li>
  ...
  return (
    <footer
      id="footer"
      className={`bg-[#050505] text-[#E8E2D2] pt-24 pb-12 z-40 relative ${pathname?.startsWith("/blog") ? "" : "border-t border-[#C1533B]/10"}`}
    >
      <div className="max-w-6xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
        ...
        <div className="md:col-span-2">
          ...
          <p className="text-[#E8E2D2]/60 font-light leading-relaxed max-w-sm mb-8">
            El ermitaño místico del Desierto de la Candelaria. Una historia de
            herejía, silencio y martirio que el fuego de la Inquisición no logró
            borrar de la memoria de Colombia.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-light text-[#E8E2D2]/70">
            <li className="flex items-start gap-3">
              <BookOpen
                size={16}
                className="shrink-0 mt-0.5 text-[#C1533B]/60"
              />
              <span className="leading-tight text-[#E8E2D2]/70">
                Libro &ldquo;Del desierto a la hoguera&rdquo; (Patricia Enciso
                Patiño)
              </span>
            </li>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 pt-8 border-t border-[#E8E2D2]/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[#E8E2D2]/30 text-xs">
        <p>
          © {new Date().getFullYear()} Proyecto Joseph Ximénez. Todos los
          derechos reservados.
        </p>
        <div className="flex gap-6">
          <Link
            href="/privacidad"
            className="hover:text-[#E8E2D2]/80 transition-colors"
            style={{ color: isActive("/privacidad") ? "#C1533B" : "inherit" }}
          >
          ...
          <Link
            href="/terminos"
            className="hover:text-[#E8E2D2]/80 transition-colors"
            style={{ color: isActive("/terminos") ? "#C1533B" : "inherit" }}
          >
            Términos Legales
          </Link>
        </div>
