...
export default function Retiro() {
  const desertSteps = [
    {
      ...
      subtitle: "33 Años · La edad del retiro",
      text: "Como otros eremitas, llegó al desierto en busca del retiro y el silencio que conducen a la paz interior. Siguió el camino de la perfección espiritual, pasando una a una por las vías Purgativa, Iluminativa o Contemplativa, y Unitiva. Fue místico autodidacta y así mismo aprendió a deletrear.",
    },
    {
  ...
  return (
    <section
      id="retiro"
      className="relative z-20 w-full overflow-hidden bg-transparent border-y border-border-theme"
    >
