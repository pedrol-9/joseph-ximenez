    ...
    <section id="inicio" className="relative min-h-dvh w-full flex flex-col items-center justify-center overflow-hidden bg-transparent">
      ...
      */}
      <div className="relative z-10 flex flex-col items-center text-center px-4 md:px-8 w-full max-w-5xl">
        ...
        >
          <span className="block text-[clamp(3.5rem,15vw,11rem)] text-text-primary">Joseph</span>
        ...
        <div className="mt-6 md:mt-10 flex flex-col items-center w-full">
          ...
          >
            ...
            >
              ...
              <div className="font-sans text-xs md:text-sm text-text-secondary max-w-sm md:max-w-md mx-auto leading-relaxed text-center flex items-center justify-center gap-1.5 transition-colors duration-300 group-hover/link:text-text-primary/60">
                <p>
                  Basado en el libro {" "}
