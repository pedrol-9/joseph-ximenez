...
const Map = dynamic(() => import("./MapComponent"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-[500px] flex items-center justify-center bg-[#100F0D] rounded-xl border border-[rgba(193,83,59,0.1)]">
      <div className="flex flex-col items-center gap-4">
        <div className="w-10 h-10 border-4 border-[#C1533B] border-t-transparent rounded-full animate-spin"></div>
        <p className="text-[#DDD8CF] font-serif italic text-lg">Cargando el mapa de ruta...</p>
      </div>
    </div>
  )
});
  ...
  return (
    <section id="mapa" className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 z-10 relative">
      <div className="text-center mb-12">
        ...
        <div className="w-24 h-1 bg-[#C1533B] mx-auto rounded-full mb-6" />
